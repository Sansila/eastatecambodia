			...
			<section class="pgl-properties pgl-bg-grey">
				<div class="container">
					...
					<div class="wizard row">
						<div class="col-md-12">
							<div class="col-md-3">
								<a class="current"><?php echo $this->lang->line('search_page_result').'('.count($all).')';?></a>
							</div>
							<div class="col-md-2">
							...
							<ul class="list-inline list-sort pull-right">
								...
								<li>
									<select id="order-status" name="order" data-placeholder="Order" class="chosen-select order_by">
										<option <?php if($order == "Desc") echo "selected"; else echo "";?> value="Desc">
											<?php echo $this->lang->line('search_page_desc')?>
										</option>
										<option <?php if($order == "Asc") echo "selected"; else echo "";?> value="Asc">
											<?php echo $this->lang->line('search_page_asc')?>
										</option>
									</select>
								</li>
