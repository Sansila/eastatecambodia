...
<?php
 ...
 <div id="breadcrumb">
      ...
      <a href='#' class="current">Project list</a>
 </div>
<div class="wrapper">
...
<script type="text/javascript">
		...
		function getdata(page){
          	var url="<?php echo site_url('project/getdata')?>";
          	var m="<?PHP echo $m?>";
          	var p="<?PHP echo $p?>";
		...
		function update(event){
				...
				location.href="<?PHP echo site_url('project/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>";
			
		}
		function deletestore(event){
			var conf=confirm("Are you sure to delete this project?");
			if(conf==true){
				var storeid=jQuery(event.target).attr("rel");
				var url="<?php echo site_url('project/delete')?>/"+storeid;
				$.ajax({
		            url:url,
		            type:"POST",
		            datatype:"Json",
