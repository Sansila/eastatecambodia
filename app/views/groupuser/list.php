...
<script type="text/javascript">
	...
	function getdata(page){
        var url="<?php echo site_url('groupuser/getdata')?>";
        var m="<?PHP echo $m?>";
        var p="<?PHP echo $p?>";
		...
		function update(event){
			...
			location.href="<?PHP echo site_url('groupuser/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>";
		}
		function deletestore(event){
			var conf=confirm("Are you Sure to delete this Group Name");
			if(conf==true){
				var storeid=jQuery(event.target).attr("rel");
				var url="<?php echo site_url('groupuser/delete')?>/"+storeid;
				$.ajax({
		            url:url,
		            type:"POST",
		            datatype:"Json",
