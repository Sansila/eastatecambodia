...
<html lang="en">
	...
	<head>
	    ...
	    <link rel="stylesheet" href="<?php echo site_url('assets/css')?>/price_range_style.css"  media="screen">
		<!-- <script src="<?php echo site_url('assets/js')?>/price_range_style.js"></script> -->
	</head>	
	            ...
	            <ul class="btn-group">
	                ...
	                <li class="btn dropdown">
	                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
	                        <i class="fa fa-user fa-fw"></i><span class="text"><?php echo $this->lang->line('setting');?></span>  <i class="fa fa-caret-down"></i>
	                    </a>
